...
INSERT INTO `barang` VALUES (3,'ANDRO-3_04-01-19_.png','121020223','Andrographis Centella',1,'Baik',250,129,85000,'Aturan Pakai : 3x2 kapsul sebelum makan.','2023-03-19'),(4,'SPIRULINA-3_04-01-19_1.png','020230314','Spirulina',1,'Baik',300,0,90000,'Aturan Pakai : 1x2 kapsul sehari.','2023-03-19'),(5,'9e28f05c-987a-4dea-9317-68e2ac80efea1.jpg','003152023','Extra Food HPAI',2,'Baik',250,40,68000,'-','2023-03-17');
...
INSERT INTO `transaksi` VALUES (39,'9e28f05c-987a-4dea-9317-68e2ac80efea1.jpg','04551241','yuda@gmail.com','089683249052','Yuda Aditya','Jl. Tanjung Wangi','Extra Food HPAI',2,10,'2','-','2023-03-18'),(40,'ANDRO-3_04-01-19_.png','04553321','rifkyputraramadhan@gmail.com','089683249052','Rifky Putra Ramadhan','Jl. Benda Cipedes','Andrographis Centella',1,5,'2','Ditunggu kak pesanannya','2023-03-19');
...
INSERT INTO `user` VALUES (1,'default.jpg','admin@gmail.com','admin','admin',1),(2,'default.jpg','yuda@gmail.com','yuda','yuda',2),(6,'default.jpg','rifkyputraramadhan@gmail.com','rifky','rifky',2);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jointransaksi` AS select `a`.`id` AS `id`,`a`.`foto` AS `foto`,`a`.`id_member` AS `id_member`,`a`.`email` AS `email`,`a`.`no_hp` AS `no_hp`,`a`.`nama` AS `nama`,`a`.`alamat` AS `alamat`,`a`.`id_kategori` AS `id_kategori`,`b`.`kategori` AS `kategori`,`a`.`produk` AS `produk`,`a`.`kuantitas` AS `kuantitas`,`a`.`status` AS `status`,`a`.`keterangan` AS `keterangan`,`a`.`tanggal_transaksi` AS `tanggal_transaksi` from (`transaksi` `a` join `kategori` `b` on(`a`.`id_kategori` = `b`.`id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-03-19 20:58:23
